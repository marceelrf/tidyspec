...
```{r plot the data, out.width = "100%",fig.alt="Static plot", fig.dpi=300}
spec_smartplot(CoHAspec)
```

### Convert to trasmittance

```{r plot the data in transmittance, out.width = "100%",fig.alt="Transmittance plot", fig.dpi=300}
CoHAspec |>
    spec_abs2trans() |>
...
```{r select the CoHA01 data, out.width = "100%",fig.alt="CoHA01 plot", fig.dpi=300}
